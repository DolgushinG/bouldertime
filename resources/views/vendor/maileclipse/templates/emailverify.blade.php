...
<td class="header-text" style="color: #ffffff; height: 192px; width: 520px;"><br /><br /><span style="font-size: 24px;">Спасибо за регистрацию!</span><br /><br />Ваш новый аккаунт почти готов для использования. Пожалуйста подтвердите ваш Email нажав на кнопку ниже.<br /><br />
<div align="left"><!-- [if mso]>
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:40px;v-text-anchor:middle;width:150px;" stroke="f" fillcolor="#2b934f">
                          <w:anchorlock/>
                          <center>
                        <![endif]--> <a style="background-color: #ff5732; color: #ffffff; display: inline-block; font-family: Helvetcia, sans-serif; font-size: 16px; font-weight: light; line-height: 40px; text-align: center; text-decoration: none; width: 150px; -webkit-text-size-adjust: none;" href="http://127.0.0.1">Activate Account</a> <!-- [if mso]>
                            </center>
                          </v:rect>
                        <![endif]--></div>
</td>
...
<tbody>
<tr>
<td style="background-color: #0e0806; color: #ffffff; font-size: 14px; text-align: center;">&copy; 2014 All Rights Reserved</td>
</tr>
</tbody>
</table>
</td>
