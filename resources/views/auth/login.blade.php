                ...
                <div class="modal-body px-4">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-group-overlay form-group">
                            <div class="input-group-prepend-overlay"><span class="input-group-text">Email<i class="fe-mail"></i></span></div>
                            <input type="email" name="email" value="{{ old('email') }}" id="email" class="form-control @error('email') is-invalid @enderror" required autocomplete="email" placeholder="Email">
                            @error('email')
                        ...
                        <div class="input-group-overlay cs-password-toggle form-group">
                            <div class="input-group-prepend-overlay"><span class="input-group-text">Пароль<i class="fe-lock"></i></span></div>
                        ...
                        <div class="d-flex justify-content-between align-items-center form-group">
                            ...
                            @if (Route::has('password.request'))
                                <a class="nav-link-style font-size-ms" href="{{ route('password.request') }}">
                                    Забыли пароль?
                                </a>
                            @endif
                        </div>
                        <button class="btn btn-primary btn-block" type="submit">Войти</button>
                        <p class="font-size-sm pt-3 mb-0">У вас нет аккаунта? <a class="ml-grid-gutter d-none d-lg-inline-block" href="#modal-signup" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-view="#modal-signup-view" >Регистрация</a></p>
